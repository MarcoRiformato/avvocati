<template>
<AppLayout title="Crea nuova categoria">
<AdminContainer>

    <div class="min-h-full">
<h1 class="text-4xl p-4">Crea nuova categoria</h1>
    ...
    <div class="border-b border-white/10 pb-12">
        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div class="sm:col-span-3">
                <label for="name" class="block font-medium leading-6">Nome</label>
                <div class="mt-2">
                    <input v-model="form.name" type="text" placeholder="Enter name" class="input input-bordered input-primary max-w-xs" />
                </div>
            </div>
            <div class="sm:col-span-3">
                <label for="media-file" class="block font-medium leading-6">Immagine</label>
                <div class="text-center mt-2">
                    <input @change="handleFileChange" type="file" class="file-input file-input-bordered file-input-primary max-w-xs" />
                    <img v-if="mediaPreview" :src="mediaPreview" alt="Uploaded Preview" class="mt-4 w-full h-auto" />
                </div>
            </div>
            ...
            <!-- Description -->
            <div class="col-span-full">
                <label for="description" class="block font-medium leading-6">Descrizione</label>
                <div class="mt-2">
