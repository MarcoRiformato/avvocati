<template>
    <AppLayout title="Crea nuovo caso studio">
    <AdminContainer>
    <div class="min-h-full">
    <h1 class="text-4xl p-4">Crea nuovo caso studio</h1>
    ...
    <div class="space-y-12">
        ...
        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <!-- Body -->
            <div class="col-span-full">
                <label for="body" class="block font-medium leading-6">Testo</label>
    ...
    <div class="mt-6 flex items-center justify-between gap-x-6">
        <button @click="$inertia.visit(route('admin.cases.index'))" type="button" class="btn btn-secondary">Cancella</button>
