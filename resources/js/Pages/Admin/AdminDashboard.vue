        ...
        <div class="px-4 sm:px-6 lg:mx-auto lg:max-w-6xl lg:px-8">
            ...
            <div class="min-w-0 flex-1">
                ...
                <div>
                    ...
                    <h1 class="ml-3 text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:leading-9">Buongiorno, avvocato!</h1>
                    </div>
            ...
            <div class="mt-6 flex space-x-3 md:ml-4 md:mt-0">
                <button type="button" class="inline-flex items-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">Crea nuovo articolo</button>
