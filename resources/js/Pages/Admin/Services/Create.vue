<template>
<AppLayout title="Crea nuovo servizio">
<AdminContainer>
<div class="min-h-full">
<h1 class="text-4xl p-4">Crea nuovo servizio</h1>
...
<div class="mt-6 flex items-center justify-between gap-x-6">
    <button @click="$inertia.visit(route('admin.services.index'))" type="button" class="btn btn-secondary">Cancel</button>
