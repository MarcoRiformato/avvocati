<template>
    ...
    <h1 class="text-3xl py-4">Partenariato Pubblico-Privato e Project Financing</h1>
  ...
  const servizi = [
    {
      title: 'Gestione di Contenziosi presso TAR e Consiglio di Stato',
