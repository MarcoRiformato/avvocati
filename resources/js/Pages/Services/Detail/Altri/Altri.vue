      ...
      <div class="md:col-span-2 space-y-6">
        <div class="px-6 lg:px-8">
            <div class="mx-auto max-w-3xl text-base leading-7">
              <h1 class="mt-2 text-3xl font-bold tracking-tight text-info sm:text-4xl">Altri settori del Diritto amministrativo</h1>
              <div class="mt-6 max-w-2xl">
                <p>Lo studio legale Giuseppe Inglese offre consulenza e assistenza specializzata in vari settori del diritto amministrativo, garantendo un supporto completo e professionale ai suoi clienti. Ci occupiamo di edilizia e urbanistica, fornendo supporto sia in fase di progettazione che durante l'esecuzione dei lavori, assicurando che tutte le normative vigenti siano rispettate. Inoltre, offriamo assistenza per i servizi pubblici, dalla gestione dei contratti alla risoluzione di controversie, garantendo una gestione efficace e conforme alle leggi.</p>

                <p class="py-4">Nel settore della sanità, lo studio Giuseppe Inglese fornisce consulenza agli enti sanitari per la gestione delle risorse, la contrattualistica e la risoluzione di problematiche legali complesse. L'assistenza si estende anche agli enti locali e al pubblico impiego, offrendo supporto nella gestione del personale, nella redazione di regolamenti interni e nella risoluzione di contenziosi. La nostra esperienza e competenza ci permettono di affrontare con successo le sfide legali più complesse, offrendo soluzioni su misura per ogni cliente.</p>
              </div>
            </div>
        </div>
