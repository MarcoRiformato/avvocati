      ...
      <div class="md:col-span-2 space-y-6">
        <div class="px-6 lg:px-8">
            <div class="mx-auto max-w-3xl text-base leading-7">
              <h1 class="mt-2 text-3xl font-bold tracking-tight text-info sm:text-4xl">Contratti e obbligazioni. Responsabilità civile. Tutela e recupero del credito</h1>
              <div class="mt-6 max-w-2xl">
                <p>Lo studio legale Giuseppe Inglese offre un servizio di consulenza e assistenza altamente specializzato in materia di contratti e obbligazioni, nonché nella gestione della responsabilità civile e nel recupero crediti. Il nostro team di esperti è a disposizione per assistere i clienti nella redazione, interpretazione, adempimento ed esecuzione di atti negoziali, garantendo che ogni fase del processo contrattuale sia gestita con la massima attenzione e professionalità. Forniamo supporto sia in ambito stragiudiziale che giudiziale, affrontando tutte le ipotesi di inadempimento e risarcimento del danno, sia contrattuale che extracontrattuale.</p>

                <p class="py-4">Inoltre, lo studio Giuseppe Inglese si occupa di responsabilità civile, offrendo consulenza per il risarcimento del danno patrimoniale e non patrimoniale. La nostra competenza si estende anche alla tutela e al recupero dei crediti, fornendo soluzioni efficaci per garantire il recupero delle somme dovute ai nostri clienti. L'obiettivo è quello di assicurare un supporto legale completo e affidabile, affrontando ogni situazione con precisione e determinazione, per proteggere al meglio gli interessi dei nostri assistiti.</p>
              </div>
            </div>
        </div>
